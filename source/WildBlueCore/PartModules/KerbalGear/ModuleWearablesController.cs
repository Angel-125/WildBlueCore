...
namespace WildBlueCore.KerbalGear
{
    ...
    public class ModuleWearablesController : BasePartModule
    {
        ...
        public override void OnStart(StartState state)
        {
            ...
            List<ModuleWearablesController> controllers = part.FindModulesImplementing<ModuleWearablesController>();
        ...
        private void setupWearableParts()
        {
            ...
            List<ModuleWearableItem> wearableItems;
            ModuleWearableItem wearableItem;
            ...
            for (int index = 0; index < count; index++)
            {
                ...
                if (availablePart.partPrefab.HasModuleImplementing<ModuleWearableItem>())
                {
