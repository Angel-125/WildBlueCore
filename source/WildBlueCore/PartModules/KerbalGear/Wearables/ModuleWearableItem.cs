...
namespace WildBlueCore.KerbalGear
{
    ...
    /// activate one or more part modules on the kerbal that provide various abilities. For example, an item can activate the WBIModuleEVAOverrides to improve the kerbal's swim speed.
