...
namespace WildBlueCore.KerbalGear
{
    ...
    /// So to get around that problem, the WBIModuleKerbalEVAModules adds a custom LoadingSystem that adds any part modules defined by a KERBAL_EVA_MODULES node to the kerbals.
