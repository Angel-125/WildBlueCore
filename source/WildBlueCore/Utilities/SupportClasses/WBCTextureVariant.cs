...
namespace WildBlueCore.Utilities
{
    ...
    internal class WBCTextureVariant
    {
        ...
        public void applyVariant(Part part)
        {
            ...
            {
                Debug.Log("[WBCTextureVariant] - No transforms to texture!");
            }
            ...
            for (int index = 0; index < textureTransformNames.Length; index++)
            {
                ...
                {
                    Debug.Log("[WBCTextureVariant] - Cannot find transform named " + textureTransformNames[index]);
                    continue;
                }
                ...
                {
                    Debug.Log("[WBCTextureVariant] - Cannot find Renderer for " + textureTransformNames[index]);
                    continue;
                }
