...
namespace WildBlueCore.Utilities
{
    internal class WBCVariant
    {
        ...
        public float mass = 0;
        public float cost = 0;
        public WBCTextureVariant textureVariant = null;
        public WBCMeshVariant meshVariant = null;
        public WBCMeshVariant colliderVariant = null;
        public string animationName = string.Empty;
        public bool animationIsEnabled = false;
        public Dictionary<string, string> extraInfo = new Dictionary<string, string>();
        public Dictionary<string, WBCVariant> meshSets = null;
        #endregion
        ...
        {
            Debug.Log("[WBCVariant] -  Applying variant: " + name);
            if (!string.IsNullOrEmpty(meshSet))
                Debug.Log("[WBCVariant] -  For mesh set: " + meshSet);
        ...
        {
             meshSets = new Dictionary<string, WBCVariant>();
            WBCVariant variant;
